...
export const PaymentPage = lazy(() =>
  import("../views/Pages/Checkout/PaymentPage").then(module => ({
    default: module.PaymentPage || module.default,
  }))
);
...
export const Register = lazy(() => import("../views/auth/Register")); // ← added
